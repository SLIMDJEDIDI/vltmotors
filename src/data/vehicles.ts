...
export const vehicles: Vehicle[] = [
  {
    ...
    description:
      "The Pulse S is built for the modern commute — silent, swift and effortlessly connected. A removable battery charges anywhere, while the full-color TFT display and app integration keep you in control. Engineered for performance and serviced by VLT Motors' certified workshop.",
    price: 5490,
    featured: true,
    isNew: true,
    inStock: true,
  ...
  },
  {
    ...
    description:
      "The Storm R is VLT's flagship electric motorcycle — a statement of performance and design. Instant torque delivers a 0–100 km/h sprint in 3.4 seconds, while a 16 kWh battery offers genuine touring range. Three ride modes adapt the machine to city, sport or eco riding.",
    price: 24900,
    oldPrice: 27500,
    featured: true,
    isNew: true,
  ...
  {
    slug: "vlt-transit-van",
    name: "VLT Transit Van",
    brand: "VLT",
  ...
  },
  {
    ...
    description:
      "An accessible, license-friendly electric scooter perfect for students and new riders. The Pulse Lite keeps things simple, affordable and fun without sacrificing VLT quality and safety.",
    price: 4990,
    oldPrice: 5490,
    featured: false,
    isNew: false,
